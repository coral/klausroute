...
var phoneconf = require('./phoneconf');
...
exports.start = function() {
    ...
    app.use('/phoneconf', phoneconf.get);
    ...
    */
    ...
    io.on('connection', function (socket) {
      ...
      _.forEach(stats.getCalls(), function(n, key) {
        socket.emit("call", n);
      });

    });

    emitter.on("call", function(data)
    {
      io.emit("call", data);
    });

    emitter.on("hangup", function(data)
    {
      io.emit("hangup", data);
    });
